...
export function AdminIcon({ name, className = 'size-5' }) {
  const icons = {
    dashboard: (
    ...
    promotions: (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a3.001 3.001 0 002.122 2.87c.94.282 1.91.422 2.878.422h.75c.966 0 1.935-.14 2.878-.422a3.001 3.001 0 002.122-2.87V6.375c0-.621-.504-1.125-1.125-1.125H3.375z" />
      </svg>
    ),
    reports: (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden>
    ...
    team: (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 2.198a3 3 0 01-4.682-2.72m8.482 0a9.094 9.094 0 00-3.741-.479m0 0a9.094 9.094 0 00-3.741.479m3.741.479a9.094 9.094 0 013.741-.479M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm6 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
      </svg>
    ),
    suppliers: (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden>
